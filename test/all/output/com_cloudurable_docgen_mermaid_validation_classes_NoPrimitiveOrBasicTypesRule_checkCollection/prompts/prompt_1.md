...
6. `Plain English Title`: Create a plain English title based on  "checkCollection (com.cloudurable.docgen.mermaid.validation.classes.NoPrimitiveOrBasicTypesRule)".
