...
# Fix for 3 main (com.cloudurable.docgen.RerunImages)
...
Regenerate a mermaid sequence diagram based on the above guidelines titled main (com.cloudurable.docgen.RerunImages) using the Java code below by
...
8. `Plain English Title`: Create a plain English title based on  "main (com.cloudurable.docgen.RerunImages)".
...
public static void main(String... args) {
    ...
    if (imageFiles.size() != mermaidFiles.size()) {
        ...
        mermaidFiles.forEach(f -> System.out.println(new File(imagesOutputDir, f + ".png")));
        mermaidFiles.forEach(f -> reRun(new File(mermaidOutputDir, f + ".mmd"), new File(imagesOutputDir, f + ".png")));
    }
}
...
,
    ...
    },
    {
        "lineNumber": 12
,
        "violatedLine": "    RerunImages->File: Create outputDir"
,
        "ruleName": "Primitive Rule"
,
        "description": "Do not include primitive or basic data types as participants in the sequence diagram. Disallow Specific Words: The line cannot contain any of the specific words: \"byte\", \"float\", \"int\", \"double\", \"long\", \"boolean\", \"char\", \"List\", \"File\", and \"bytes\".\n\nDisallow Square Brackets: The line cannot contain a square bracket character, either opening \"[\" or closing \"]\". Do not include \":\". Do not include angle brackets \"<\" \">\". Use ~ instead of angle brackets \n"
    ...
    },
    {
        "lineNumber": 14
,
        "violatedLine": "    RerunImages->File: Create mermaidOutputDir"
,
        "ruleName": "Primitive Rule"
,
        "description": "Do not include primitive or basic data types as participants in the sequence diagram. Disallow Specific Words: The line cannot contain any of the specific words: \"byte\", \"float\", \"int\", \"double\", \"long\", \"boolean\", \"char\", \"List\", \"File\", and \"bytes\".\n\nDisallow Square Brackets: The line cannot contain a square bracket character, either opening \"[\" or closing \"]\". Do not include \":\". Do not include angle brackets \"<\" \">\". Use ~ instead of angle brackets \n"
    ...
    },
    {
        "lineNumber": 15
,
        "violatedLine": "    RerunImages->File: Create imagesOutputDir"
,
        "ruleName": "Primitive Rule"
,
        "description": "Do not include primitive or basic data types as participants in the sequence diagram. Disallow Specific Words: The line cannot contain any of the specific words: \"byte\", \"float\", \"int\", \"double\", \"long\", \"boolean\", \"char\", \"List\", \"File\", and \"bytes\".\n\nDisallow Square Brackets: The line cannot contain a square bracket character, either opening \"[\" or closing \"]\". Do not include \":\". Do not include angle brackets \"<\" \">\". Use ~ instead of angle brackets \n"
    ...
    },
    {
        "lineNumber": 21
,
        "violatedLine": "    RerunImages->File: Create File (reRun)"
,
...
,
    ...
    },
    {
        "lineNumber": 23
,
        "violatedLine": "    RerunImages->File: Call reRun method"
,
        "ruleName": "Primitive Rule"
,
        "description": "Do not include primitive or basic data types as participants in the sequence diagram. Disallow Specific Words: The line cannot contain any of the specific words: \"byte\", \"float\", \"int\", \"double\", \"long\", \"boolean\", \"char\", \"List\", \"File\", and \"bytes\".\n\nDisallow Square Brackets: The line cannot contain a square bracket character, either opening \"[\" or closing \"]\". Do not include \":\". Do not include angle brackets \"<\" \">\". Use ~ instead of angle brackets \n"
